...
public class ConnectDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        textReference.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(textReference, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(94, 94, 94)
    ...
    private void buttonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOKActionPerformed
        if(!textReference.getText().isEmpty())
        {
            textReference.setBackground(Color.GREEN);
            PatientGUI patient = new PatientGUI(textReference.getText());
            patient.setVisible(true);
            this.dispose();
        }
        else
        {
            textReference.setBackground(Color.red);
        }
